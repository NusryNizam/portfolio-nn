...
function App() {
  ...
  useEffect(() => {
    ...
    // Entering Animation for ePocket
    gsap.to(ePocketEl, {
      borderRadius: 0,
      scrollTrigger: {
        trigger: ePocketEl,
          ...
          <div className="content">
            ...
            <div className="socials">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Go to Dribbble profile"
              >
                <svg className="icon">
